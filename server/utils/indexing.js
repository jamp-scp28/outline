...
async function collectionIndexing(teamId) {
  ...
  const sortable = (0, _naturalSort.default)(collections, collection => collection.name); // for each collection with null index, use previous collection index to create new index

...
function requireDirectory(dirName) {
  return _fsExtra.default.readdirSync(dirName).filter(file => file.indexOf(".") !== 0 && file.match(/\.[jt]s$/) && file !== _path.default.basename(__filename) && !file.includes(".test")).map(fileName => {

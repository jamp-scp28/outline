...
var heavyWeightRegex = /^(bold(er)?|[5-9]\d{2,})$/;
var normalWeightRegex = /^(normal|[1-4]\d{2,})$/;
      ...
      return {
        parseDOM: [{
          ...
          getAttrs: function getAttrs(dom) {
            return normalWeightRegex.test(dom.style.fontWeight) ? false : null;
          }
        }, {
          tag: "strong"
        }, {
          ...
          getAttrs: function getAttrs(style) {
            return heavyWeightRegex.test(style) && null;
          }
        }],

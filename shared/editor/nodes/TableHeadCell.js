...
var TableHeadCell = /*#__PURE__*/function (_Node) {
  _inherits(TableHeadCell, _Node);
      ...
      return [new _prosemirrorState.Plugin({
        props: {
          decorations: function decorations(state) {
            ...
            var decorations = [];
            var cells = (0, _prosemirrorUtils.getCellsInRow)(0)(selection);

            if (cells) {
              cells.forEach(function (_ref, index) {
                var pos = _ref.pos;
                decorations.push(_prosemirrorView.Decoration.widget(pos + 1, function () {
                  var colSelected = (0, _prosemirrorUtils.isColumnSelected)(index)(selection);
                  ...
                  grip.addEventListener("mousedown", function (event) {
                    ...
                    _this.editor.view.dispatch((0, _prosemirrorUtils.selectColumn)(index)(state.tr));
                  });
                  return grip;
                }));
              });

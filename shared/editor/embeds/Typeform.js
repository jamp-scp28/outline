...
var URL_REGEX = new RegExp("^https://([A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?).typeform.com/to/(.*)$");

var Typeform = /*#__PURE__*/function (_React$Component) {
  _inherits(Typeform, _React$Component);

  var _super = _createSuper(Typeform);

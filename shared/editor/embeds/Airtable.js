...
var URL_REGEX = new RegExp("https://airtable.com/(?:embed/)?(shr.*)$");

var Airtable = /*#__PURE__*/function (_React$Component) {
  _inherits(Airtable, _React$Component);

  var _super = _createSuper(Airtable);
  ...
  _createClass(Airtable, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_Frame.default, _extends({}, this.props, {
        src: "https://airtable.com/embed/".concat(shareId),
        title: "Airtable (".concat(shareId, ")"),
        border: true
      }));
    }
  }]);

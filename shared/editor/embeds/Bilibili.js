...
var URL_REGEX = /(?:https?:\/\/)?(www\.bilibili\.com)\/video\/([\w\d]+)?(\?\S+)?/i;
  ...
  _createClass(Vimeo, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_Frame.default, _extends({}, this.props, {
        src: "https://player.bilibili.com/player.html?bvid=".concat(videoId, "&page=1&high_quality=1"),
        title: "Bilibili Embed (".concat(videoId, ")")
      }));
    }
  }]);

...
var URL_REGEX = new RegExp("^https://framer.cloud/(.*)$");

var Framer = /*#__PURE__*/function (_React$Component) {
  _inherits(Framer, _React$Component);

  var _super = _createSuper(Framer);

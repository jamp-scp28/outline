...
var _useComponentSize2 = _interopRequireDefault(require("../components/useComponentSize"));
...
var URL_REGEX = /^https:\/\/(www\.)?berrycast.com\/conversations\/(.*)$/;

function Berrycast(props) {
  var normalizedUrl = props.attrs.href.replace(/\/$/, "");
  var ref = React.useRef(null);

  var _useComponentSize = (0, _useComponentSize2.default)(ref),

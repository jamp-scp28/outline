...
var URL_REGEX = new RegExp("https?://open.spotify.com/(.*)$");

var Spotify = /*#__PURE__*/function (_React$Component) {
  _inherits(Spotify, _React$Component);

  var _super = _createSuper(Spotify);
  ...
  _createClass(Spotify, [{
    ...
    get: function get() {
      try {
        var parsed = new URL(this.props.attrs.href);
    ...
    value: function render() {
      var normalizedPath = this.pathname.replace(/^\/embed/, "/");
      var height;
